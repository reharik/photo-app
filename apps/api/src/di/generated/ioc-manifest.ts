...
import * as ioc_______packages_context_media_core_src_repositories_readRepositories_grantReadRepository from '@packages/media-core';
...
import * as ioc_src_controllers_mediaServeController from '../../controllers/mediaServeController.js';
...
import * as ioc_src_middleware_mediaAuthMiddleware from '../../middleware/mediaAuthMiddleware.js';
...
import * as ioc_src_routes_mediaPublicRouter from '../../routes/mediaPublicRouter.js';
import * as ioc_src_server from '../../server.js';
import * as ioc_src_services_authService from '../../services/authService.js';
import * as ioc_src_services_mediaGrantService from '../../services/mediaGrantService.js';
...
export const iocManifest = {
  moduleImports: [
    ...
    ioc_______packages_context_media_core_src_repositories_readRepositories_grantReadRepository,
    ...
    ioc_src_controllers_mediaServeController,
    ...
    ioc_src_middleware_mediaAuthMiddleware,
    ...
    ioc_src_routes_mediaPublicRouter,
    ioc_src_server,
    ioc_src_services_authService,
    ioc_src_services_mediaGrantService,
  ...
  contracts: {
    ...
    GrantReadRepository: {
      grantReadRepository: {
        exportName: 'buildGrantReadRepository',
        registrationKey: 'grantReadRepository',
        modulePath:
          '../../packages/context/media-core/src/repositories/readRepositories/grantReadRepository.ts',
        relImport: '@packages/media-core',
    ...
    MediaAuthMiddleware: {
      mediaAuthMiddleware: {
        exportName: 'buildMediaAuthMiddleware',
        registrationKey: 'mediaAuthMiddleware',
        modulePath: 'src/middleware/mediaAuthMiddleware.ts',
    ...
    MediaGrantService: {
      mediaGrantService: {
        exportName: 'buildMediaGrantService',
        registrationKey: 'mediaGrantService',
        modulePath: 'src/services/mediaGrantService.ts',
        ...
        default: true,
        discoveredBy: 'naming',
        dependencyContractNames: ['GrantReadRepository', 'MediaItemReadRepository'],
      },
    },
    MediaItemReadRepository: {
      mediaItemReadRepository: {
    ...
    MediaPublicRouter: {
      mediaPublicRouter: {
        exportName: 'buildMediaPublicRouter',
        registrationKey: 'mediaPublicRouter',
        modulePath: 'src/routes/mediaPublicRouter.ts',
    ...
    MediaServeController: {
      mediaServeController: {
        ...
        modulePath: 'src/controllers/mediaServeController.ts',
