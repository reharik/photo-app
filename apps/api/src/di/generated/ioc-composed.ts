...
type _MediaCore_rateLimiter =
  _MediaCoreExternalsPick['rateLimiter'] extends MediaCoreExternals['rateLimiter'] ? true : false;
type _MediaCore_rateLimiterAssert = _IocExpect<_MediaCore_rateLimiter>;
// If any assertion below is `false`, run `ioc validate` for a detailed per-key explanation.
...
export const composedRegistrationOverrides = {
  ...
  contracts: {
    AuthMiddleware: {
      defaultImplementation: 'optionalAuthMiddleware',
    },
  },
