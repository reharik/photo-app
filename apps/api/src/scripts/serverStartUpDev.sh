...
# Migrations run in the `migrate` one-shot service (see docker-compose-dev.yml,
# and docker-compose-ci.yml / -prod.yml for the other environments); this
# container gates on it via depends_on: service_completed_successfully.
#
