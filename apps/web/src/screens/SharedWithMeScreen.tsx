...
export const SharedWithMeScreen = () => {
  ...
  // No list-level clear here: shared media now shows a per-tile unseen dot, and each
  // clears on opening that photo (MediaItemScreen fires markSurfaceSeen ITEM_SHARED).
  // Merely viewing the list is NOT "seeing" the individual items.
