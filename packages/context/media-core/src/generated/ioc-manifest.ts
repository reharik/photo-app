...
import * as ioc_domain_Album_eventHandlers_resolveActivity from '../domain/Album/eventHandlers/resolveActivity.js';
import * as ioc_domain_Album_eventHandlers_unseenActivityEmailHandler from '../domain/Album/eventHandlers/unseenActivityEmailHandler.js';
import * as ioc_domain_Album_eventHandlers_unseenActivityNotificationHandler from '../domain/Album/eventHandlers/unseenActivityNotificationHandler.js';
...
import * as ioc_domain_User_eventHandlers_publicLinkEmailHandler from '../domain/User/eventHandlers/publicLinkEmailHandler.js';
...
type IocManifestGroupRoots = {
  ...
  readonly domainEventHandlers: {
    ...
    readonly members: readonly [
      ...
      {
        readonly contractName: 'DomainEventHandler';
        readonly registrationKey: 'publicLinkEmailHandler';
      },
      {
        readonly contractName: 'DomainEventHandler';
        readonly registrationKey: 'unseenActivityEmailHandler';
      },
      {
        readonly contractName: 'DomainEventHandler';
        readonly registrationKey: 'unseenActivityNotificationHandler';
      },
    ];
  };
...
export const iocManifest = {
  ...
  moduleImports: [
    ...
    ioc_domain_Album_eventHandlers_resolveActivity,
    ioc_domain_Album_eventHandlers_unseenActivityEmailHandler,
    ioc_domain_Album_eventHandlers_unseenActivityNotificationHandler,
    ...
    ioc_domain_User_eventHandlers_publicLinkEmailHandler,
  ...
  contracts: {
    ...
    DomainEventHandler: {
      ...
      publicLinkEmailHandler: {
        exportName: 'build__PublicLinkEmailHandler',
        registrationKey: 'publicLinkEmailHandler',
        modulePath: 'domain/User/eventHandlers/publicLinkEmailHandler.ts',
        relImport: '../domain/User/eventHandlers/publicLinkEmailHandler.js',
        contractName: 'DomainEventHandler',
        implementationName: 'publicLinkEmailHandler',
        lifetime: 'singleton',
        moduleIndex: 7,
        discoveredBy: 'naming',
        dependencyContractNames: [
      ...
      unseenActivityEmailHandler: {
        exportName: 'build__UnseenActivityEmailHandler',
        registrationKey: 'unseenActivityEmailHandler',
        modulePath: 'domain/Album/eventHandlers/unseenActivityEmailHandler.ts',
        relImport: '../domain/Album/eventHandlers/unseenActivityEmailHandler.js',
        contractName: 'DomainEventHandler',
        implementationName: 'unseenActivityEmailHandler',
        lifetime: 'singleton',
        moduleIndex: 2,
        discoveredBy: 'naming',
        dependencyContractNames: ['ResolveActivity', 'SystemPendingNotificationRepository'],
      },
      unseenActivityNotificationHandler: {
        exportName: 'build__UnseenActivityNotificationHandler',
        registrationKey: 'unseenActivityNotificationHandler',
        modulePath: 'domain/Album/eventHandlers/unseenActivityNotificationHandler.ts',
        relImport: '../domain/Album/eventHandlers/unseenActivityNotificationHandler.js',
        contractName: 'DomainEventHandler',
    ...
    ResolveActivity: {
      resolveActivity: {
        exportName: 'build__ResolveActivity',
        registrationKey: 'resolveActivity',
        modulePath: 'domain/Album/eventHandlers/resolveActivity.ts',
        relImport: '../domain/Album/eventHandlers/resolveActivity.js',
        contractName: 'ResolveActivity',
        implementationName: 'resolveActivity',
        lifetime: 'singleton',
        moduleIndex: 1,
        default: true,
        discoveredBy: 'naming',
