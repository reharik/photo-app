 ...
 * @property {string | import("node:stream").Writable} [destination]
 * @property {import("pino").Logger} [logger]
 */

/**
 * @typedef {Object} ConvertResult
 * @property {Buffer} outputBuffer
 ...
 */
export const isHeic = async (input) => {
 ...
 */
export const convertHeicToJpeg = async (input, options = {}) => {
 ...
 */
const readInputToBuffer = async (input) => {
 ...
 */
const applyExifOrientation = (jpegBuffer, orientation) => {
 ...
 */
const transformRgba = (source, width, height, orientation) => {
 ...
 */
const orientationCoordinateMapper = (orientation, width, height) => {
  switch (orientation) {
    case 2:
 ...
 * @param {string | import("node:stream").Writable} destination
